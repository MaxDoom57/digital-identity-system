            ...
            <div style={{
                    ...
                    <>
                        <div style={{ marginBottom: 28 }}>
                            ...
                            <div style={{ fontSize: 11, color: theme.textMuted }}>
                                Step {step} of 3 — {['Personal Details', 'Contact & Address', 'Biometric Capture'][step - 1]}
                            </div>
                        </div>
                ...
                {step === 3 && (
                    <div>
                        ...
                        {biometricHash && (
                            <div style={{
                                background: theme.bg, borderRadius: 8, padding: 12,
                                border: `1px solid ${theme.borderLight}`, marginBottom: 20
                            }}>
                                <div style={{
                    ...
                    <div style={{ textAlign: 'center', padding: '20px 0' }}>
                        ...
                        <div style={{
                            ...
                            {['Admin reviews your biometric and NIC details',
                                ...
                                'Log in to access your digital identity'].map((s, i) => (
                                    <div key={i} style={{
